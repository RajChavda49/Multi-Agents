const STATUS_STYLES = {
  ...
  awaiting_target_clarification: "bg-orange-600/30 text-orange-300 border border-orange-500/40",
  awaiting_code_clarification: "bg-orange-600/30 text-orange-300 border border-orange-500/40",
...
const STATUS_LABELS = {
  ...
  awaiting_target_clarification: "Confirm edit files",
  awaiting_code_clarification: "Confirm code write",
